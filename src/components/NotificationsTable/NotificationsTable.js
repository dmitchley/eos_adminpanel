...
import { getTotalSizeofNotifications } from 'actionStore/FirebaseAction/notificationAction';
...
const headCells = [
    { id: 'noti_title', numeric: false, disablePadding: true, label: 'Title' },
    { id: 'noti_body', numeric: false, disablePadding: false, label: 'Body' },
    { id: 'readStatus', numeric: false, disablePadding: false, label: 'Read Status' },
];
...
export default function EnhancedTable(props) {
    ...
    const getTotalPagesCount = async () => {
        const totalPages = await getTotalSizeofNotifications();
        setCount(totalPages)
    }
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className={classes.tableCell} >{row.noti_title}</TableCell>
                                        <TableCell className={classes.tableCell} >{row.noti_body}</TableCell>

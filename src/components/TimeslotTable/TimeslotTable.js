...
import { getTotalSizeofTimeSlot } from 'actionStore/FirebaseAction/timeslotAction';
...
export default function EnhancedTable(props) {
    ...
    const getTotalPagesCount = async () => {
        const totalPages = await getTotalSizeofTimeSlot();
        setCount(totalPages)
    }
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className={classes.minTableCell} >{row.duration}</TableCell>

...
export default function EnhancedTable(props) {
    const { tableHead, tableData, tableHeaderColor, status, isRead, totalRow, showLoader } = props;
    ...
    const [count, setCount] = React.useState(totalRow); // current page
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className={classes.tableCell}>{isRead ? `true` : `false`}</TableCell>
                                    </TableRow>
                                );
                            })}
                        {showLoader ? (

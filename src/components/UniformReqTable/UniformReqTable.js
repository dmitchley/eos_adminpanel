...
import { getTotalSizeofRequest } from 'actionStore/FirebaseAction/uniformRequestAction';
...
const headCells = [
    ...
    { id: 'uniformItem', numeric: true, disablePadding: false, label: 'Uniform Item' },
];
...
export default function EnhancedTable(props) {
    ...
    const [isLoaderTimeout, setLoaderTimeout] = React.useState(0);
    ...
    const getTotalPagesCount = async () => {
        const totalPages = await getTotalSizeofRequest();
        setCount(totalPages)
    }
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* <TableCell className={classes.minTableCell} >{row.age}</TableCell> */}
                                        <TableCell className={classes.tableCell} >{row.size}</TableCell>
                                        <TableCell className={classes.tableCell} >{row.uniform_item}</TableCell>
                                    </TableRow>
                                );
                            })}
                        {showLoader ? (

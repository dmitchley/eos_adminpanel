...
import avatar from "assets/img/faces/user_avatar.png";
...
const headCells = [
    ...
    { id: 'mobile', numeric: true, disablePadding: false, label: 'Primary Mobile' },
    { id: 'address', numeric: false, disablePadding: false, label: 'Address' },
    { id: 'addChild', numeric: false, disablePadding: false, label: 'Add Child' },
    { id: 'edit', numeric: false, disablePadding: false, label: 'Edit Parent' },
...
export default function EnhancedTable(props) {
    ...
    const onEditParent = (selectedData) => {
        props.onEditParent(selectedData)
    }
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* <TableCell className={classes.tableCell} component="th" id={labelId} scope="row" padding="none">
                                            <div className={classes.cardAvatarProfile}>
                                                <a href="#pablo" onClick={e => e.preventDefault()}>
                                                    <img src={avatar} className={classes.cardProfileImg} />
                                                </a>
                                                <img src={avatar} alt="Avatar" style="width:200px"></img>
                                            </div>
                                        </TableCell> */}
                                        <TableCell className={classes.tableCell} component="th" id={labelId} scope="row" padding="none">
                                        ...
                                        <TableCell className={classes.tableCell} >{row.primaryMobile}</TableCell>
                                        <TableCell className={classes.tableCell} >{row.addressLine1}</TableCell>
                                        <TableCell className={classes.tableActions}>
                                            ...
                                            >
                                                ...
                                                >
                                                    <AddCircleOutline className={classes.tableActionButtonIcon + " " + classes.edit} />
                                                </IconButton>
                                            </Tooltip>
                                        </TableCell>
                                        <TableCell className={classes.tableActions}>
                                        ...
                                        <TableCell className={classes.tableActions}>
                                            <Tooltip
                                                id="tooltip-top"
                                                title={row.password ? "Change Password" : "Set Password"}
                                                placement="top"
                                                classes={{ tooltip: classes.tooltip }}
                                            >
                                                <IconButton

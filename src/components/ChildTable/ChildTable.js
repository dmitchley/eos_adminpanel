...
const headCells = [
    { id: 'childname', numeric: false, disablePadding: true, label: 'Child Name' },
    { id: 'parenname', numeric: false, disablePadding: false, label: 'Paren Name' },
    { id: 'age', numeric: true, disablePadding: false, label: 'Age' },
    { id: 'startdate', numeric: false, disablePadding: false, label: 'Start Date' },
    { id: 'edit', numeric: false, disablePadding: false, label: 'Edit Child' },
    { id: 'delete', numeric: false, disablePadding: false, label: 'Delete Child' },
];
...
export default function EnhancedTable(props) {
    ...
    const onEditChild = (selectedData) => {
        props.onEditChild(selectedData)
    }

    const onDeleteChild = (selectedData) => {
        props.onDeleteChild(selectedData)
    }
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className={classes.tableCell} >{row.parentName}</TableCell>
                                        <TableCell className={classes.tableCell} >{row.age}</TableCell>
                                        <TableCell className={classes.tableCell} >{row.start_date}</TableCell>

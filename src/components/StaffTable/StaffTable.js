...
import { getTotalSizeofStaffList } from 'actionStore/FirebaseAction/staffListAction';
...
const headCells = [
    // { id: 'teacherId', numeric: false, disablePadding: true, label: 'TeacherId' },
...
export default function EnhancedTable(props) {
    ...
    const onDeleteStaff = (selectedData) => {
        props.onDeleteStaff(selectedData)
    }
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className={classes.minTableCell} >{row.fname}</TableCell>
                                        <TableCell className={classes.tableCell} >{row.lname}</TableCell>
